...
Если вам нравится SuperCaption, **поставьте звёздочку на GitHub**! Это помогает развитию проекта и показывает, что он полезен сообществу.
...
## Дополнительные опции описания

### Для изображений

| Опция | Что добавляет |
|-------|---------------|
| Информация об освещении | Описание источников света и их влияния |
| Ракурс камеры | Угол съёмки и перспектива |
| Водяной знак | Наличие/отсутствие водяных знаков |
| JPEG артефакты | Качество сжатия изображения |
| Детали камеры/фото | Апертура, выдержка, ISO (если применимо) |
| SFW/PG рейтинг | Исключение взрослого контента |
| Эстетическая оценка | Субъективная оценка качества |
| Стиль композиции | Правило третей, симметрия, ведущие линии |
| Глубина резкости | Фокус и размытие фона |
| Только ключевые элементы | Фокус на самом важном |

### Для видео

| Опция | Что добавляет |
|-------|---------------|
| Движение камеры | Панорамирование, зум, статика |
| Описание звука | Музыка, речь, звуковые эффекты |
| Сюжет/история | Развитие событий |
| Таймстампы | Временные метки в формате ЧЧ:ММ:СС |
| Стиль монтажа | Переходы, темп, эффекты |
| Только ключевые моменты | Фокус на важных событиях |
...
|----------|----------|--------------|
| **Температура** | Креативность | 0.1-0.3 для точных задач, 0.7-1.0 для творческих |
| **Max tokens** | Длина ответа | 256-512 для кратких, 1024+ для подробных |
| **Top-p** | Nucleus sampling | 0.9 для баланса, 0.5 для фокусировки |
| **Top-k** | Ограничение токенов | 50 по умолчанию |
| **Seed** | Воспроизводимость | Конкретное число для повторяемости, -1 для случайного |
